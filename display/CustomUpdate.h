#ifdef ESP32
#ifndef CUSTOM_UPDATER_H
#define CUSTOM_UPDATER_H
...
class CustomUpdateClass {
  public:
    typedef std::function<void(size_t, size_t)> THandlerFunction_Progress;

    CustomUpdateClass(const char* partition = NULL);

    /*
      This callback will be called when Update is receiving data
    */
    CustomUpdateClass& onProgress(THandlerFunction_Progress fn);
